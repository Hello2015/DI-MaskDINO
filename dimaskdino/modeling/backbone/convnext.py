# ------------------------------------------------------------------------
# ConvNeXt Backbone for DI-MaskDINO
# ------------------------------------------------------------------------
import torch
...
class D2ConvNeXt(ConvNeXt, Backbone):
    """
    ConvNeXt backbone for Detectron2.
    """
    def __init__(self, cfg, input_shape):
        ...
        # Map out_features to indices
        feature_to_idx = {"res2": 0, "res3": 1, "res4": 2, "res5": 3}
        out_indices = [feature_to_idx[f] for f in out_features]
